...
class Seminar(Module):
    ...
    def __str__(self):
        ...
        return("Seminar in {} under the topic: {}" .format(self.get_title(), self.get_topic()))
...
class Thesis(Module):
    ...
    def __str__(self):
        ...
        return ("Bachelor thesis on the topic: {} on {} in the research group {}" .format( self.get_topic(), self.get_title(), self.get_research_group()))
